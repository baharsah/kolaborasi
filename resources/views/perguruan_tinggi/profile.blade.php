              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="row justify-content-end mb-3">
                    ...
                    <div class="col-md-6">
                      <input id="prodi" type="text" class="form-control @error('prodi') is-invalid @enderror" name="prodi" value="{{ $account->name }}" required autocomplete="prodi" autofocus>
                  ...
                  <div class="row justify-content-end mb-3">
                    ...
                    <div class="col-md-6">
                      <input id="prodi" type="text" class="form-control @error('prodi') is-invalid @enderror" name="prodi" value="{{ $account->jabatan }}" required autocomplete="prodi" autofocus>
                ...
                <div class="col-md-6">
                  ...
                  <div class="row justify-content-start mb-3">
                    ...
                    <div class="col-md-6">
                      <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ $account->email }}" required autocomplete="email" autofocus>
